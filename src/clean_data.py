...
class PopulationDataPreprocessor:
    ...
    def load_population_data(self):
        ...
        self.pop_df['Number of Births'] = (
            self.pop_df['Number of women in US'] *
            (self.pop_df['Crude birth rate per 1,000 women'] / 1000)
        )
        self.pop_df['Number of Deaths'] = (
            self.pop_df['US Population'] *
    ...
    def fit_logistic_curve(self):
        ...
        self.params, _ = curve_fit(self._logistic_function,
                                 self.cdc_years,
                                 self.cdc_values)
    ...
    def predict_early_viral_suppression(self, years_to_predict):
        ...
        new_rows = pd.DataFrame({
            ...
            "Viral Suppression Proportion": predicted_values
        })
    ...
    def adjust_viral_suppression(self):
        ...
        adj_viral_df = pd.DataFrame({
            ...
            'Viral Suppression Proportion': np.nan
        })

        viral_sup_ratio = (
            self.cdc_data[2011] /
            self.viral_df.loc[self.viral_df['Year'] == 2011, 'Viral Suppression Proportion']
        ).iloc[0]
        ...
        for year in adj_viral_df['Year']:
            if year < 1995:
                adj_viral_df.loc[adj_viral_df['Year'] == year, 'Viral Suppression Proportion'] = (
                    0.1 * 0.1 + early_90s_addition * early_90s_multiplier
                )
                early_90s_multiplier += 1
            elif 1995 <= year < 2011:
                adj_viral_sup_value = viral_sup_ratio * self.viral_df.loc[
    ...
    def process_data(self):
        ...
        self.pop_df['Viral Suppression Proportion'] = adj_viral_df['Viral Suppression Proportion']
        return self.pop_df
